...
export default function Hero(){
    return(
        <div className={styles.hero}>
            ...
            <h1 className={styles.heroTitle}>Generate flash card <span>width AI</span> </h1>
            <p className={styles.heroSubTitle}>Transform your notes into study sets automatically.</p>
